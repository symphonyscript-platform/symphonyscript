 ...
 *   - quantize(480, 1).steps(note(6000)) snaps tick to grid
...
describe('QuantizationBuilder', () => {
  ...
  describe('quantize() factory', () => {
    ...
    it('quantize(480, 1).steps(note(6000)) should be chainable and applyable', () => {
      const bridge = createBridge({ defaultDuration: 480 })
      const result = quantize(480, 1).steps(note(6000)).apply(bridge)
  ...
  describe('strength 1', () => {
    ...
    it('should snap downward when closer to previous grid', () => {
      ...
      const result = quantize(480, 1)
        .steps(note(6000).duration(200), note(6000))
        .apply(bridge)
    ...
    it('should snap upward when past midpoint', () => {
      ...
      const result = quantize(480, 1)
        .steps(note(6000).duration(300), note(6000))
        .apply(bridge)
  ...
  describe('strength 0', () => {
    it('strength 0 should leave tick unchanged', () => {
      ...
      const result = quantize(480, 0)
        .steps(note(6000).duration(240), note(6000))
        .apply(bridge)
    ...
    it('should preserve off-grid positions at strength 0', () => {
      ...
      const result = quantize(480, 0)
        .steps(note(6000).duration(100), note(6000))
        .apply(bridge)
  ...
  describe('grid param', () => {
    it('should respect different grid sizes', () => {
      ...
      const result2 = quantize(240, 1)
        .steps(note(6000).duration(150), note(6000))
        .apply(bridge2)
  ...
  describe('default (cascading) usage', () => {
    it('should return modified bridge when used without .steps()', () => {
      ...
      const result = note(6000).duration(240).apply(modified)
      const result2 = note(6000).apply(result)
