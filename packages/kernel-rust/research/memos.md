...
**Why:** Avoids redundant kernel writes. If a cue's output hasn't changed between evaluations, no MEM mutations occur. Enables efficient re-evaluation when parameters change without full recompilation.
