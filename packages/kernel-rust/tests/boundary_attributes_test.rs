...
use symphonyscript_kernel::node::boundary_attributes::{BoundaryAttributes, BoundaryAttributesView};
...
fn view_round_trip() {
    ...
    let view = BoundaryAttributesView(NodeAttributesView::new(&sab, 0));
