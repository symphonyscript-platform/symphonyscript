use symphonyscript_kernel::constants::SYNAPSE_SLOT_SIZE;
use symphonyscript_kernel::primitives::into_array::IntoArray;
use symphonyscript_kernel::structural_plane::synapse::synapse_data::SynapseData;
