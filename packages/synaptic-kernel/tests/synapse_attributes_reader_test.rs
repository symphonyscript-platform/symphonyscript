...
use synaptic_kernel::attribute_plane::reader::synapse_attributes_reader::SynapseAttributesReader;
...
use synaptic_kernel::constants::SYNAPSE_ATTRIBUTES_SLOT_SIZE;
