...
**You write to:** `research/workflow/composer/communication/` (files named `*-by-architect-*.md`)
...
```bash
./research/workflow/scripts/watch-folder.sh research/workflow/composer/communication "*-by-engineer-*.md"
```
...
1. **WAIT:** Run `./research/workflow/scripts/watch-folder.sh research/workflow/composer/communication "*-by-engineer-*.md"` — command blocks until new file appears
